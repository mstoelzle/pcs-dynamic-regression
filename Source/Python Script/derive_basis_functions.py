...
Lagr_expr, true_coeffs_before_norm, _, _ = constructLagrangianExpression(sym_exps, states_sym, states_epsed_sym, xi_eq, B_xi, strain_selector, params, epsilon_bend)
